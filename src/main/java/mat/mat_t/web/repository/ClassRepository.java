...
public interface ClassRepository extends JpaRepository<Classes, Long> {
         ...
         */
        // 강사 아이디로 조회
        @Query(value = "select new mat.mat_t.form.ClassForm(c.classId, c.instructorC.instructorId, c.title, c.numberOfStudents, c.descriptions, c.place, c.startTime, c.endTime, c.category, c.startDate, c.endDate, c.classSt, count(distinct ws.userWS.id) , count(distinct cs.userCS.id), i.userIn.name, i.major, coalesce(avg(ir.score), -1))"
                        +
                        ...
                        " group by c.classId, c.instructorC.instructorId, c.title, c.numberOfStudents, c.descriptions, c.place, c.startTime, c.endTime, c.category, c.startDate, c.endDate, c.classSt,  i.userIn.name, i.major")
