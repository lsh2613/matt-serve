...
public class WaitingStudentsRepository {
    ...
    public List<WaitingStudent> findListByClassId(Long classId) {
        ...
        return em
                .createQuery("select w from WaitingStudent w join w.classesWS c where c.classId=:classId",
    ...
    public List<WaitingStudent> findListByClassIdAndUserId(Long classId, Long userId) {
        ...
        return em.createQuery(
                "select w from WaitingStudent w join w.classesWS c join w.userWS u where c.classId=:classId and u.id=:userId",
                WaitingStudent.class)
                .setParameter("classId", classId)
